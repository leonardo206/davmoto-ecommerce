<?php
namespace GrandPrixCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'grandprix-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'grandprix-core' ) => 'accordion',
								esc_html__( 'Toggle', 'grandprix-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
							...
							'value'      => array(
								esc_html__( 'Boxed', 'grandprix-core' )  => 'boxed',
						...
						array(
							...
							'heading'    => esc_html__( 'Background Skin', 'grandprix-core' ),
							'value'      => array(
								esc_html__( 'Default', 'grandprix-core' ) => '',
								esc_html__( 'White', 'grandprix-core' )   => 'white'
							),
	...
	public function render( $atts, $content = null ) {
		...
		$output = grandprix_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );
