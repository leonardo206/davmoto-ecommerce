...
class PricingTableItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Pricing Table Item', 'grandprix-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Set Item As Active', 'grandprix-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Background Color', 'grandprix-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'tagline',
							'heading'     => esc_html__( 'Tagline', 'grandprix-core' ),
							'value'       => esc_html__( 'Extended Licencse', 'grandprix-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'textfield',
							...
							'value'       => esc_html__( 'Basic Plan', 'grandprix-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'price',
							'heading'    => esc_html__( 'Price', 'grandprix-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'price_color',
							'heading'    => esc_html__( 'Price Color', 'grandprix-core' ),
							'dependency' => array( 'element' => 'price', 'not_empty' => true )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'currency',
							'heading'     => esc_html__( 'Currency', 'grandprix-core' ),
							'description' => esc_html__( 'Default mark is $', 'grandprix-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'currency_color',
							'heading'    => esc_html__( 'Currency Color', 'grandprix-core' ),
							'dependency' => array( 'element' => 'currency', 'not_empty' => true )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'price_period',
							'heading'     => esc_html__( 'Price Period', 'grandprix-core' ),
							'description' => esc_html__( 'For example monthly, weekly etc.', 'grandprix-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'price_period_color',
							'heading'    => esc_html__( 'Price Period Color', 'grandprix-core' ),
						...
						array(
							...
							'value'       => esc_html__( 'PURCHASE NOW', 'grandprix-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = grandprix_core_get_shortcode_module_template_part( 'templates/pricing-table-template', 'pricing-table', '', $params );
