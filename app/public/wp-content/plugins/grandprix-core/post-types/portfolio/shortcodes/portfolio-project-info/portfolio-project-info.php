...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function render( $atts, $content = null ) {
		...
		if ( ! empty( $project_info_title ) ) {
			$html .= '<' . grandprix_mikado_core_escape_title_tag( $project_info_title_tag ) . ' class="mkdf-ppi-label">' . esc_html( $project_info_title ) . '</' . grandprix_mikado_core_escape_title_tag( $project_info_title_tag ) . '>';
		}
	...
	public function getItemTitleHtml( $params ) {
		...
		if ( ! empty( $title ) ) {
			$html = '<' . grandprix_mikado_core_escape_title_tag( $title_tag ) . ' itemprop="name" class="mkdf-ppi-title entry-title">';
				$html .= '<a itemprop="url" href="' . esc_url( get_the_permalink( $project_id ) ) . '">' . esc_html( $title ) . '</a>';
			$html .= '</' . grandprix_mikado_core_escape_title_tag( $title_tag ) . '>';
		}
