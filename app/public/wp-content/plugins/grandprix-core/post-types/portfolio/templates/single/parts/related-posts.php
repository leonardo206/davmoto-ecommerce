...
$show_related_posts = grandprix_mikado_options()->getOptionValue('portfolio_single_related_posts') == 'yes';

$post_id = get_the_ID();
$related_posts = grandprix_core_get_portfolio_single_related_posts($post_id);
?>
