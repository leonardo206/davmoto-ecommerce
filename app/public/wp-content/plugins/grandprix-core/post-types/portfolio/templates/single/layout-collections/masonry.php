<?php
$masonry_classes   = '';
$number_of_columns = grandprix_mikado_get_meta_field_intersect( 'portfolio_single_masonry_columns_number' );
if ( ! empty( $number_of_columns ) ) {
	$masonry_classes .= ' mkdf-' . $number_of_columns . '-columns';
}
$space_between_items = grandprix_mikado_get_meta_field_intersect( 'portfolio_single_masonry_space_between_items' );
...
<div class="mkdf-ps-image-holder mkdf-grid-list mkdf-grid-masonry-list mkdf-fixed-masonry-items mkdf-disable-bottom-space <?php echo esc_attr( $masonry_classes ); ?>">
	<div class="mkdf-ps-image-inner mkdf-outer-space mkdf-masonry-list-wrapper">
		...
		<?php
		$media = grandprix_core_get_portfolio_single_media(true);
