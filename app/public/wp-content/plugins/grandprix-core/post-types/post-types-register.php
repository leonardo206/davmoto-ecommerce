...
namespace GrandPrixCore\CPT;

use GrandPrixCore\Lib;

/**
 * Class PostTypesLoader
 * @package GrandPrixCore\CPT
 */
class PostTypesRegister {
	...
	private function addPostTypes() {
		$cpt_class_name = apply_filters( 'grandprix_core_filter_register_custom_post_types', $cpt_class_name = array() );
