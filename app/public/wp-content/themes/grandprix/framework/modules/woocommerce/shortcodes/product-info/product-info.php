...
class ProductInfo implements Lib\ShortcodeInterface {
	...
	public function getItemTitleHtml( $params ) {
		...
		if ( ! empty( $title ) ) {
			$html = '<' . grandprix_mikado_escape_title_tag( $title_tag ) . ' itemprop="name" class="mkdf-pi-title entry-title" ' . grandprix_mikado_get_inline_style( $product_info_style ) . '>';
				$html .= '<a itemprop="url" href="' . esc_url( get_the_permalink( $product_id ) ) . '">' . esc_html( $title ) . '</a>';
			$html .= '</' . grandprix_mikado_escape_title_tag( $title_tag ) . '>';
		}
			...
			$html .= '<div class="mkdf-pi-category">';
				foreach ( $categories as $cat ) {
					if ( ! empty( $params['category_tag'] ) ) {
						$html .= '<' . grandprix_mikado_escape_title_tag( $params['category_tag'] ) . ' ' . grandprix_mikado_get_inline_style( $product_info_style ) . '>';
						$html .= '<a itemprop="url" class="mkdf-pi-category-item" href="' . esc_url( get_term_link( $cat->term_id ) ) . '">' . esc_html( $cat->name ) . '</a>';
						$html .= '</' . grandprix_mikado_escape_title_tag( $params['category_tag'] ) . '>';
					} else {
